    ...
    >
      <div className="relative w-full max-w-md max-h-full">
        <div className="relative bg-white p-2 rounded-3xl shadow-2xl  ">
          <button
            type="button"
            className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-red-200 hover:text-black rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center "
          ...
          <div className="px-6 py-6 lg:px-8">
            ...
            <h1 className="mb-4 ml-16 text-5xl font-medium text-gray-800 ">
              {" "}
